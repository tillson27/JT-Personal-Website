              ...
              <ul className="mt-2 space-y-1.5 text-[11px] leading-snug text-white/85">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    2025 —{" "}
                    <span className="font-semibold text-white">16.9%</span> of sales
                    overall, ~<span className="font-semibold text-white">24.5%</span> online.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-0.5 flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-md bg-purple-500/20 text-[9px] font-semibold text-purple-200">
                  ...
                  <span>
                    Apparel that sits a few weeks loses{" "}
                    <span className="font-semibold text-white">25–50%</span> to
                    markdown, and <span className="font-semibold text-white">50–60%</span>{" "}
                    needs cleaning or minor repair to resell.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    A mid-sized-warehouse worker makes{" "}
                    <span className="font-semibold text-white">400–800</span> disposition
                    calls per shift, mostly by gut feel.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-0.5 flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-md bg-fuchsia-500/20 text-[9px] font-semibold text-fuchsia-200">
                  ...
                  <span>
                    <span className="font-semibold text-white">EU 2026:</span> destroying
                    unsold clothing is banned — wrong calls now carry regulatory risk on
                    top of margin loss.
                  </span>
                </li>
              </ul>
              <p className="mt-auto pt-2 text-[9px] leading-snug text-white/40">
                Sources:{" "}
